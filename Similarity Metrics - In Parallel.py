...
class SimilarityMetric:
    ...
    def parallel_jaccard_similarity(self, x, y):
        ...
        intersection_cardinality = sum(
            pool.starmap(self.interc_card_locl, zip(chunk_X, chunk_Y))
        )
        union_cardinality = sum(
            pool.starmap(self.union_card_locl, zip(chunk_X, chunk_Y))
        )
        print(intersection_cardinality, union_cardinality)
        e = time.clock()
...
def main():
    ...
    print(
        "Jaccard Similarity: ",
        sm.serial_jaccard_similarity(
            [x for x in range(0, 30000, 3)], [x for x in range(0, 20000, 2)]
        ),
    )
    e = time.clock()
    ...
    print(
        "Parallel Jaccard similarity: ",
        sm.parallel_jaccard_similarity(
            [x for x in range(0, 30000, 3)], [x for x in range(0, 20000, 2)]
        ),
    )
    ...
    print(
        "Cosine similarity: ",
        sm.serial_cosine_similarity(
            [x for x in range(0, 30000000, 3)], [x for x in range(0, 20000000, 2)]
        ),
    )
    e = time.clock()
    ...
    print(
        "Minkowski Distance: ",
        sm.serial_minkowski_distance(
            [x for x in range(0, 30000000, 3)], [x for x in range(0, 20000000, 2)], 3
        ),
    )
    e = time.clock()
    print("Serial Minkowski Distance  Time: ", e - s)
    print(
        "Parallel Minkowski Distance similarity: ",
        sm.parallel_minkowski_distance(
            [x for x in range(0, 30000000, 3)], [x for x in range(0, 20000000, 2)], 3
        ),
    )
    ...
    print(
        ...
        sm.parallel_manhattan_distance(
            [x for x in range(0, 30000000, 3)], [x for x in range(0, 20000000, 2)]
        ),
    )
    ...
    print(
        "Parallel Euclidean Distance: ",
        sm.parallel_euclidean_distance(
            [x for x in range(0, 30000000, 3)], [x for x in range(0, 20000000, 2)]
        ),
    )
